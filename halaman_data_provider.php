...
<h2>Daftar Provider Active</h2>
<a href="input_provider.php" type="button" class="btn btn-default">+ Tambah Data</a> 
<br></br>
<?php
...
$query="SELECT * FROM providertbl limit $posisi, $batas";      
$no=1+$posisi;    
...
echo "<td> <a href=\"edit_provider.php?id_provider=".$row["id_provider"]."\"  class=\"glyphicon glyphicon-pencil\" title=\"Klik untuk mengedit data\"> </a> &nbsp; &nbsp; <span class=\"test\"> <a href=\"hapus_provider.php?id_provider=".$row["id_provider"]."\"  class=\"glyphicon glyphicon-remove text text-danger\" id=\"btn\" title=\"Klik untuk menghapus data\"> </a>  </span></td>";
...
$jml_data= mysql_num_rows(mysql_query("SELECT * FROM providertbl"));
