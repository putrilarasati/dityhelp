...
<h5>Untuk menambahkan indikator baru pada penilaian layanan, silahkan isi data berikut :</h5>
...
<div class="alert alert-success">
  <strong>Success!</strong> Indikator Baru berhasil ditambahkan.
</div>
 <?php
}
else {
...
<div class="alert alert-danger">
  <strong>Gagal!</strong> Indikator Baru gagal ditambahkan, mohon periksa kembali format pengisian.
</div>
<?php
}
}
...
<div class="form-group">
      ...
      <input class="form-control" id="focusedInput" name="indikator" type="text">
    </div>
<form>
<div>
...
mysql_query("INSERT INTO indikatortbl(indikator)
VALUE('$indikator')")or die(mysql_error());
header('location:input_indikator.php?berhasil=1');
}
else {
header('location:input_indikator.php?berhasil=2');
}
}
?>
</body>
