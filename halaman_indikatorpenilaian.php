...
$query="SELECT * FROM indikatortbl limit $posisi, $batas";      
$no=1+$posisi;    
...
echo "<td> <a href=\"edit_indikator.php?id_indikator=".$row["id_indikator"]."\"  class=\"glyphicon glyphicon-pencil\" title=\"Klik untuk mengedit data\"> </a> &nbsp; &nbsp; <span class=\"test\" > <a href=\"hapus_indikator.php?id_indikator=".$row["id_indikator"]."\"  class=\"glyphicon glyphicon-remove text text-danger\" title=\"Klik untuk menghapus data\"> </a> </span></td>";
echo "</tr>";
...
$jml_data= mysql_num_rows(mysql_query("SELECT * FROM indikatortbl"));
